...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Configure SMTP transporter with enhanced error handling
    ...
    const adminEmailContent = {
      from: `"Nexariza AI Contact Form" <${process.env.SMTP_USER || 'contact@nexariza.com'}>`,
    ...
    // Send both emails with enhanced error handling
    try {
