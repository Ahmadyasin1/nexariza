  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isDevelopment) {
        ...
        console.log('📧 DEVELOPMENT MODE - Form submitted:', formData);
        ...
        setSubmitSuccess('Development mode: Form submitted successfully! In production, both admin and user emails will be sent.');
        setIsSubmitted(true);
        setFormData({
          name: '',
          email: '',
      ...
      if (dbConnected) {
        ...
        const savedSubmission = await contactService.submitContactForm(submissionData);
        console.log('✅ Contact submission saved to database:', savedSubmission.id);
        } catch (dbError) {
          handleDatabaseError(dbError, 'contact form storage');
      ...
      if (response.ok) {
        setSubmitSuccess(result.message || 'Message sent successfully! Your submission has been saved and confirmation emails sent. Check your email for next steps.');
        setIsSubmitted(true);
        setFormData({
          name: '',
          email: '',
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-green-200 text-sm leading-relaxed">
                          {submitSuccess || 'Thank you for contacting Nexariza AI! We\'ve received your message and will respond within 24 hours. Please check your email for a detailed confirmation with next steps.'}
                        </p>
